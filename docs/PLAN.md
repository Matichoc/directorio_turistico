...
14. La galería de fotos de cada lugar (`place_images` en el esquema) está sin poblar — la ficha de lugar muestra "Galería de fotos: próximamente" en vez de fotos reales. Conectar un conector de imágenes (p. ej. Unsplash, ya disponible como MCP pero no conectado en esta sesión) o subir fotos propias a Supabase Storage antes de mostrar la galería.
